...
project = u"easyserver"
copyright = u"2021-2022, duino"
...
latex_documents = [
    ("index", "MyProject.tex", u"My Project", u"Ryan Roemer", "manual"),
]
...
man_pages = [("index", "myproject", u"My Project", [u"Ryan Roemer"], 1)]
